...
# Build the complete HTML that includes Preface, Epigraph, TOC, Ch1, Ch2
html_content = """<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>The Myth of Sisyphus — Complete Critical Dual-Track Edition</title>
<style>
  @page {
    size: A4 landscape;
    margin: 1.2cm 1.5cm;
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  [data-theme="dark"] header.nav-header { background: rgba(20, 21, 24, 0.95); }
  .nav-title { font-size: 0.9rem; font-weight: 700; color: var(--accent-red); }
  ...
  /* Parallel Two-Column Units (Immutable Fixed Grid) */
  .parallel-unit {
    display: table;
    width: 100%;
    table-layout: fixed;
  ...
  .parallel-row { display: table-row; }
  .col-orig, .col-mod {
    display: table-cell;
    width: 50%;
    vertical-align: top;
  ...
  .col-mod { background: var(--bg-card); }
  ...
  .prose-orig { color: var(--text-secondary); font-size: 0.92rem; line-height: 1.58; }
  .prose-mod { color: var(--text-primary); font-size: 0.95rem; line-height: 1.58; }
...
<header class="nav-header">
  <div class="nav-title">The Myth of Sisyphus <span>— Complete Parallel Edition</span></div>
...
<div class="book-container">
  ...
  <section class="cover-page">
    <div class="cover-tag">A Parallel Critical & Modern Edition</div>
    <h1 class="cover-title">The Myth of Sisyphus</h1>
    <div class="cover-author">Albert Camus</div>
    <div class="cover-meta">
      <p>Original French by Albert Camus (1942)</p>
      <p>English Translation by Justin O'Brien (1955) • Paired with Dignified Modern Literary Translation</p>
      <p style="margin-top: 1.5rem; font-style: italic;">"O my soul, do not aspire to immortal life, but exhaust the limits of the possible." — Pindar</p>
    </div>
  </section>

  <!-- PREFACE BY ALBERT CAMUS (1955) -->
  <div class="chapter-header">
    <div class="chapter-title">Author's Preface (Paris, March 1955)</div>
    <div class="chapter-meta">Albert Camus's Retrospective Introduction</div>
  </div>
  ...
  <!-- EPIGRAPH & INTRODUCTORY NOTE -->
  <div class="chapter-header">
    <div class="chapter-title">Dedication, Epigraph & Introductory Note</div>
    <div class="chapter-meta">Flyleaf of the Original 1942 Edition</div>
  </div>
  ...
  <section class="toc-page">
    ...
    <div class="toc-list">
      <div>
        <div class="toc-section-title">Preliminary Matter</div>
        <div class="toc-item"><span>Author's Preface (1955)</span> <span>Included</span></div>
        <div class="toc-item"><span>Dedication & Pindar Epigraph</span> <span>Included</span></div>
        <br>
        <div class="toc-section-title">Part I: An Absurd Reasoning</div>
        <div class="toc-item active"><span>1. Absurdity and Suicide</span> <span>Complete</span></div>
        <div class="toc-item active"><span>2. Absurd Walls</span> <span>Complete</span></div>
        <div class="toc-item"><span>3. Philosophical Suicide</span> <span>Upcoming</span></div>
        <div class="toc-item"><span>4. Absurd Freedom</span> <span>Upcoming</span></div>
      </div>
      <div>
        <div class="toc-section-title">Part II: The Absurd Man</div>
        <div class="toc-item"><span>• Don Juanism</span> <span></span></div>
        <div class="toc-item"><span>• Drama</span> <span></span></div>
        <div class="toc-item"><span>• Conquest</span> <span></span></div>
        <br>
        <div class="toc-section-title">Part III: Absurd Creation</div>
        <div class="toc-item"><span>• Philosophy and Fiction</span> <span></span></div>
        <div class="toc-item"><span>• Kirilov</span> <span></span></div>
        <div class="toc-item"><span>• Ephemeral Creation</span> <span></span></div>
        <br>
        <div class="toc-section-title">Part IV: The Myth of Sisyphus</div>
        <div class="toc-item"><span>• The Myth of Sisyphus (The Finale)</span> <span></span></div>
      </div>
    </div>
  </section>

  <!-- CHAPTER 1: ABSURDITY AND SUICIDE -->
  <div class="chapter-header">
    <div class="chapter-title">Part I: An Absurd Reasoning — 1. Absurdity and Suicide</div>
    <div class="chapter-meta">Albert Camus (1942)</div>
  </div>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> Establishing a hierarchy of urgency: academic metaphysics are intellectual games; the question of biological survival and value precedes all theoretical contemplation.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> Galileo rightly refused martyrdom because physics does not alter the lived weight of existence, whereas meaning dictates literal life and death.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> Camus rejects bloodless academic debate in favor of balancing observable evidence with existential passion.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> Shifting the focus from external sociological factors to inner consciousness: "To begin to think is to begin to be undermined."
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> Suicide defined as the shattering of habit. We live by biological inertia; suicide is the sudden realization that this inertia lacks any ultimate purpose.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> The core definition of the Absurd: the "divorce"—the painful rift between human craving for home/meaning and an indifferent cosmos.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> Exposing our two buffers: the biological body's survival instinct, and the intellectual trap of Hope (deferring reality to an afterlife or a utopian future).
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> The foundational question: Does meaninglessness logically demand death? Or can reason find a way to inhabit the Absurd with defiance?
        </td>
      </tr>
    </tfoot>
  </table>

  <!-- CHAPTER 2: ABSURD WALLS -->
  <div class="chapter-header">
    <div class="chapter-title">Part I: An Absurd Reasoning — 2. Absurd Walls</div>
    <div class="chapter-meta">Albert Camus (1942)</div>
  </div>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> The collapse of routine. Habit numbs consciousness; the sudden eruption of "Why?" ends unconscious living and demands a definitive response.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> The betrayal of time: living on future credit blinds us to mortality until turning thirty reveals time as an executioner.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> The soundproof telephone booth and the mirror stranger. Stripped of context, human behavior is exposed as mechanical pantomime, triggering existential vertigo.
        </td>
      </tr>
    </tfoot>
  </table>
  ...
  <table class="parallel-unit">
    ...
    <tfoot class="move-footer">
      <tr>
        <td colspan="2">
          <strong>The Philosophical Move:</strong> The universe is not absurd; it is simply indifferent. The Absurd is the spark struck when human longing collides with that indifference.
        </td>
      </tr>
    </tfoot>
  </table>
...
print(f"Wrote complete HTML reader to {html_path}")
...
print("Rendering complete Two-Column Landscape PDF...")
...
if res.returncode == 0:
    ...
    print(f"Synced complete PDF to iCloud Apple Books: {dest_icloud}")
else:
